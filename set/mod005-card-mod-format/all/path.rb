...
module Path;
extend Card::Set
def self.source_location; "/Users/ezl5238/dev/decko/gem/card-mod-format/set/all/path.rb"; end
...
# ~~ generated from /Users/ezl5238/dev/decko/gem/card-mod-format/set/all/path.rb ~~
