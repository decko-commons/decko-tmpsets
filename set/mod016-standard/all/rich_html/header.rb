# -*- encoding : utf-8 -*-
class Card; module Set; class All; module RichHtml; module Header; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/header.rb ~~
format :html do
  view :header do |args|
    %(
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/header.rb ~~
end;end;end;end;end;
