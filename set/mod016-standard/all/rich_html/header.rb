...
# ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/header.rb ~~
format :html do
  view :header do |args|
    %(
...
# ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/header.rb ~~
end;end;end;end;end;
