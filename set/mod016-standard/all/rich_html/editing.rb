# -*- encoding : utf-8 -*-
class Card; module Set; class All; module RichHtml; module Editing; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/editing.rb ~~
format :html do
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/rich_html/editing.rb ~~
end;end;end;end;end;
