# -*- encoding : utf-8 -*-
class Card; module Set; class All; module Links; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/links.rb ~~
format do
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/standard/set/all/links.rb ~~
end;end;end;end;
