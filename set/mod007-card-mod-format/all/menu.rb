...
module Menu;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/card-mod-format/set/all/menu.rb"; end
...
# ~~ generated from /Users/ethan/dev/decko/gem/card-mod-format/set/all/menu.rb ~~
