...
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/email/set/type_plus_right/user/follow.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/email/set/type_plus_right/user/follow.rb ~~
end;end;end;end;end;
