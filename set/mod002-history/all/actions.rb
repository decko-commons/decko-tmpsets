...
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/history/set/all/actions.rb ~~
# -*- encoding : utf-8 -*-
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/history/set/all/actions.rb ~~
end;end;end;end;
