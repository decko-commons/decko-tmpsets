# -*- encoding : utf-8 -*-
class Card; module Set; class Type; module Setting; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/settings/set/type/setting.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/settings/set/type/setting.rb ~~
end;end;end;end;
