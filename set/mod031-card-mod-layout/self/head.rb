...
module Head;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/card-mod-layout/set/self/head.rb"; end
...
# ~~ generated from /Users/ethan/dev/decko/gem/card-mod-layout/set/self/head.rb ~~
