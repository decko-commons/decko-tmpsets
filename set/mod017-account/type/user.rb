# -*- encoding : utf-8 -*-
class Card; module Set; class Type; module User; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/type/user.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/type/user.rb ~~
end;end;end;end;
