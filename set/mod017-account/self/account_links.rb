# -*- encoding : utf-8 -*-
class Card; module Set; class Self; module AccountLinks; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/self/account_links.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/self/account_links.rb ~~
end;end;end;end;
