# -*- encoding : utf-8 -*-
class Card; module Set; class Right; module Token; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/right/token.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/right/token.rb ~~
end;end;end;end;
