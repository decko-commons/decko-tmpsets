# -*- encoding : utf-8 -*-
class Card; module Set; class Right; module Account; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/right/account.rb ~~
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/right/account.rb ~~
end;end;end;end;
