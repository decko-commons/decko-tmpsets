# -*- encoding : utf-8 -*-
class Card; module Set; class All; module Account; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/all/account.rb ~~
module ClassMethods
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/all/account.rb ~~
end;end;end;end;
