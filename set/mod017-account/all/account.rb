...
# ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/all/account.rb ~~
module ClassMethods
...
# ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/account/set/all/account.rb ~~
end;end;end;end;
