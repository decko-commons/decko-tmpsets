...
# ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/01_head/javascript.rb ~~
format :html do
...
# ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/01_head/javascript.rb ~~
end;end;end;end;end;
