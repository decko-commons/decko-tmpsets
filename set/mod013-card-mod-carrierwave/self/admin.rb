...
module Admin;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/mod/carrierwave/set/self/admin.rb"; end
add_to_basket(
  :tasks,
...
# ~~ generated from /Users/ethan/dev/decko/gem/mod/carrierwave/set/self/admin.rb ~~
