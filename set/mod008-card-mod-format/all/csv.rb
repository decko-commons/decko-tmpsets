...
module Csv;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/card-mod-format/set/all/csv.rb"; end
require "csv"
...
# ~~ generated from /Users/ethan/dev/decko/gem/card-mod-format/set/all/csv.rb ~~
