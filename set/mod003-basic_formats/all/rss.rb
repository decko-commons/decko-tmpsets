# -*- encoding : utf-8 -*-
class Card; module Set; class All; module Rss; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/all/rss.rb ~~
format :rss do
  attr_accessor :xml
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/all/rss.rb ~~
end;end;end;end;
