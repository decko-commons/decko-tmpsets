# -*- encoding : utf-8 -*-
class Card; module Set; class All; module Base; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/all/base.rb ~~
format do
  def show view, args
    view ||= :core
    render view, args
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/all/base.rb ~~
end;end;end;end;
