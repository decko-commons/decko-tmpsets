# -*- encoding : utf-8 -*-
class Card; module Set; class Self; module Head; module Javascript; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/01_head/javascript.rb ~~
format :html do
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/01_head/javascript.rb ~~
end;end;end;end;end;
