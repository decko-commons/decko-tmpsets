...
# ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/head.rb ~~
format :html do
  view :raw do
    output [
      head_meta,
...
# ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/head.rb ~~
end;end;end;end;
