# -*- encoding : utf-8 -*-
class Card; module Set; class Self; module Head; extend Card::Set
# @!visibility ~~ above autogenerated; below pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/head.rb ~~
format :html do
  view :raw do
    output [
      head_meta,
...
# @!visibility ~~ below autogenerated; above pulled from /Users/ethan/dev/wagn/gem/card/mod/basic_formats/set/self/head.rb ~~
end;end;end;end;
