...
module Actions;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/mod/history/set/all/history/actions.rb"; end
...
# ~~ generated from /Users/ethan/dev/decko/gem/mod/history/set/all/history/actions.rb ~~
