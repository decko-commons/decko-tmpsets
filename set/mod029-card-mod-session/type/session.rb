...
module Session;
extend Card::Set
def self.source_location; "/Users/ethan/dev/decko/gem/card-mod-session/set/type/session.rb"; end
include_set Pointer
...
# ~~ generated from /Users/ethan/dev/decko/gem/card-mod-session/set/type/session.rb ~~
